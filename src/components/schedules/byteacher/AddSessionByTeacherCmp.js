...
export default function AddSessionByTeacherCmp(props) {
  ...
  const [loading, setLoading] = useState(true);
    ...
    useEffect(() => {
      if(props.toadd){
        db.teachers.get(Number.parseInt(props.toadd.teacher_id)).then(res=>{
          if(res){
          setTeacher(res);
          setLoading(false);
        }
    ...
    useEffect(() => {
      setInputs({
        subject_id:'',
        class_id:'',
        teacher_id:props.toadd.teacher_id,
        classroom_id:'',
  ...
  <div className="tab-content" id="myTabContent">
      ...
      <div className="form-group">
                      ...
                      <div className="input-group">
                             <select name="teacher_id" value={inputs.teacher_id} className='form-control' disabled>
                             <option>Sélectionner Prof</option>
